...
<head>
    <meta charset="utf-8" />
    <link rel="icon" href="/passwd/react/favicon.ico" />
    <meta name="viewport" content="width=device-width,initial-scale=1" />
    <meta name="theme-color" content="#000000" />
    <meta name="description" content="Web site created using create-react-app" />
    <link rel="apple-touch-icon" href="/passwd/react/logo192.png" />
    <link rel="manifest" href="/passwd/react/manifest.json" />
    <title>React App</title>
    <script>
        globalThis.horde = <?php echo $this->jsGlobals ?>
    </script>
</head>
...
<body><noscript>You need to enable JavaScript to run this app.</noscript>
    ...
    <script>
        ! function(e) {
            ...
            var a = this.webpackJsonppasswdtool = this.webpackJsonppasswdtool || [],
                p = a.push.bind(a);
            a.push = t, a = a.slice();
    ...
    <script src="/passwd/react/static/js/2.7c6e4ad8.chunk.js"></script>
    <script src="/passwd/react/static/js/main.c0d6b395.chunk.js"></script>
</body>
